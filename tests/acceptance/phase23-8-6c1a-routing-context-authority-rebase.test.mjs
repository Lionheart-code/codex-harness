...
test("phase 24A is active after the completed and harvested Phase 23.9", () => {
  assert.equal(
  ...
  assert.ok(progression.includes("23.8.7"), "published near-term progression must retain Phase 23.8.7");
