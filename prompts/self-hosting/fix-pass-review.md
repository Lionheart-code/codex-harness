# Self-hosting Procedure Wrapper: `fix-pass-review`

This wrapper is a derived, non-authoritative invocation helper.

Canonical authority:

- `skills/self-hosting/fix-pass-review/SKILL.md`
- `skills/self-hosting/fix-pass-review/references/output-format.md`
- `skills/self-hosting/fix-pass-review/references/source-notes.md`
...
Run only the `fix-pass-review` procedure. Return the exact output format from
