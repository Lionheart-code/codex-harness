# Self-hosting Procedure Wrapper: `implementation-review`

This wrapper is a derived, non-authoritative invocation helper.

Canonical authority:

- `skills/self-hosting/implementation-review/SKILL.md`
- `skills/self-hosting/implementation-review/references/output-format.md`
- `skills/self-hosting/implementation-review/references/source-notes.md`
...
Run only the `implementation-review` procedure. Return the exact output format
