# Self-hosting Procedure Wrapper: `db-storage-review`

This wrapper is a derived, non-authoritative invocation helper.

Canonical authority:

- `skills/self-hosting/db-storage-review/SKILL.md`
- `skills/self-hosting/db-storage-review/references/output-format.md`
- `skills/self-hosting/db-storage-review/references/source-notes.md`
...
Run only the `db-storage-review` procedure. Return the exact output format from
