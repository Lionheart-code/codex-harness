# Self-hosting Procedure Wrapper: `plan-amend`

This wrapper is a derived, non-authoritative invocation helper.

Canonical authority:

- `skills/self-hosting/plan-amend/SKILL.md`
- `skills/self-hosting/plan-amend/references/output-format.md`
- `skills/self-hosting/plan-amend/references/source-notes.md`
