# Self-hosting Procedure Wrapper: `task-prompt-writer`

This wrapper is a derived, non-authoritative invocation helper.

Canonical authority:

- `skills/self-hosting/task-prompt-writer/SKILL.md`
- `skills/self-hosting/task-prompt-writer/references/output-format.md`
- `skills/self-hosting/task-prompt-writer/references/source-notes.md`
...
Run only the `task-prompt-writer` procedure. Return the exact output format from
