# Self-hosting Procedure Wrapper: `phase-closeout-review`
...
- `skills/self-hosting/phase-closeout-review/references/output-format.md`
- `skills/self-hosting/phase-closeout-review/references/source-notes.md`
...
Run only the `phase-closeout-review` procedure. Return the exact output format
