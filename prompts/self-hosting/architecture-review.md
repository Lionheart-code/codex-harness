# Self-hosting Procedure Wrapper: `architecture-review`

This wrapper is a derived, non-authoritative invocation helper.

Canonical authority:

- `skills/self-hosting/architecture-review/SKILL.md`
- `skills/self-hosting/architecture-review/references/output-format.md`
- `skills/self-hosting/architecture-review/references/source-notes.md`
